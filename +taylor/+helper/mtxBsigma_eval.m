...
% Extract quadrature arrays
    ...
    mex_id_ = 'mtxbsigma_eval_addsub(c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[xx], c i int[x], c i int[x], c i double[xx], c i double[x], c i dcomplex[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i dcomplex[xx], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i dcomplex[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[x], c i int[x], c i dcomplex[xx], c i dcomplex[xx], c i dcomplex[x], c io dcomplex[xx], c io dcomplex[xx])';
