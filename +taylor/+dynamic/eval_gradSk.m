...
% Call layer potential evaluator
    mex_id_ = 'lpcomp_gradhelm_addsub(c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[xx], c i int[x], c i int[x], c i double[xx], c i double[x], c i dcomplex[x], c i int[x], c i int[x], c i int[x], c i int[x], c i int[x], c i dcomplex[xx], c i dcomplex[x], c i int[x], c i int[x], c i int[x], c i double[xx], c i double[x], c io dcomplex[xx])';
