classdef RefTaylorState < TaylorState
    ...
    methods
        ...
        function wfunc = solveforW(obj,varargin)
            ...
            wfunc = cell(obj.nsurfaces,1);
            b = zeros(obj.nptspersurf,obj.nsurfaces);
            for i = 1:obj.nsurfaces
                nB0 = dot(obj.vn{i},obj.B0{i});
                b(:,i) = surfacefun_to_array(nB0,obj.dom{i},obj.surf{i});
            end
            ...
            [W,~,~,iter] = gmres(@(s) TaylorState.gmresA(s, ...
                obj.dom,obj.surf,obj.L,obj.zk,obj.eps_taylor, ...
            ...
            for i = 1:obj.nsurfaces
                ...
                wfunc{i} = array_to_surfacefun(W(inds),obj.dom{i}, ...
                    obj.surf{i});
            end
        end
        ...
        function obj = compute_sigma_alpha(obj,varargin)
            ...
            if obj.nsurfaces == 1
                fluxsigmaD = RefTaylorState.mtxfluxsigmanontaylor(...
                    obj.surf{1},obj.dom{1},obj.L{1},obj.xs_nodes{1},...
                    obj.xs_weights{1},dfunc{1},obj.zk,obj.eps_taylor,...
                    obj.eps_laphelm);
                fluxsigmaW = RefTaylorState.mtxfluxsigmanontaylor(...
                    obj.surf{1},obj.dom{1},obj.L{1},obj.xs_nodes{1},...
                    obj.xs_weights{1},wfunc{1},obj.zk,obj.eps_taylor,...
                    obj.eps_laphelm);
                fluxalpha = RefTaylorState.mtxfluxalphanontaylor(...
                    obj.surf{1},obj.dom{1},obj.xs_nodes{1},...
                    obj.xs_weights{1},obj.mH{1},obj.zk,obj.eps_taylor,...
                    obj.eps_laphelm);
            else
                fluxsigmaD = RefTaylorState.mtxfluxsigmanontaylor(...
                    obj.surf,obj.dom,obj.L,obj.xs_nodes,obj.xs_weights,dfunc,...
                    obj.zk,obj.eps_taylor,obj.eps_laphelm);
                fluxsigmaW = RefTaylorState.mtxfluxsigmanontaylor(...
                    obj.surf,obj.dom,obj.L,obj.xs_nodes,obj.xs_weights,wfunc,...
                    obj.zk,obj.eps_taylor,obj.eps_laphelm);
                fluxalpha = RefTaylorState.mtxfluxalphanontaylor(...
                    obj.surf,obj.dom,obj.xs_nodes,obj.xs_weights,obj.mH,obj.zk,...
