            ...
            for j = 1:obj.nsurfaces
                for k = 1:obj.nsurfaces
                    ...
                    fluxsigmaD(j,k) = ...
                        ...
                        j-1,obj.xs_nodes{j},obj.xs_weights{j}, ...
                        dfunc{k},obj.zk,obj.eps_taylor,obj.eps_laphelm, ...
                    ...
                    fluxsigmaW(j) = fluxsigmaW(j) + ...
                        ...
                        obj.surf{k},obj.dom{k},obj.L{k}, ...
                        j-1,obj.xs_nodes{j},obj.xs_weights{j}, ...
                        wfunc{k},obj.zk,obj.eps_taylor,obj.eps_laphelm, ...
                        obj.quad_opts_xs_taylor{j,k}, ...
                        obj.quad_opts_xs_laphelm{j,k});
                    fluxalpha(j,k) = ...
                        RefTaylorState.mtxfluxalphanontaylor( ...
                        obj.surf{k},obj.dom{k},j-1,obj.xs_nodes{j}, ...
                        obj.xs_weights{j},obj.mH{k},obj.zk, ...
