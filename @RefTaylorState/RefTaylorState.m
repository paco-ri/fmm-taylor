classdef RefTaylorState < TaylorState
    ...
    methods
        ...
        function obj = compute_sigma_alpha(obj,varargin)
            ...
            if obj.nsurfaces == 1
                ...
                fluxsigmaD = RefTaylorState.mtxfluxsigmanontaylor(...
                    obj.surf,obj.dom,obj.vn,obj.L,obj.xs_nodes, ...
                ...
                fluxsigmaW = RefTaylorState.mtxfluxsigmanontaylor(...
                    ...
                    obj.eps_laphelm);
                fluxalpha = RefTaylorState.mtxfluxalphanontaylor(...
                    obj.surf,obj.dom,obj.xs_nodes, ...
                    obj.xs_weights,obj.mH,obj.zk,obj.eps_taylor, ...
                    obj.eps_laphelm);
            end
    ...
    methods (Static)
        fluxsigma = mtxfluxsigmanontaylor(S,dom,vn,params,nodes,weights, ...
