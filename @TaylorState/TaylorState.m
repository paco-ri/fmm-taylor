classdef TaylorState
            ...
            if obj.nsurfaces == 1
                ...
                if surfacequad
                    ...
                    fluxsigmaD = -1.*TaylorState.mtxfluxsigmanontaylor(...
                        obj.surf,obj.dom,obj.L,nodes,weights,dfunc,...
                        obj.zk,obj.eps_taylor,obj.eps_laphelm);
    ...
    methods (Static)
        ...
        fluxsigmanontaylor = mtxfluxsigmanontaylor(S,dom,L,nodes,weights,sigma,zk,epstaylor,epslh,varargin)
        fluxalphanontaylor = mtxfluxalphanontaylor(S,dom,nodes,weights,mH,zk,epstaylor,epslh,varargin)
