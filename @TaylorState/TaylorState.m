classdef TaylorState
        ...
        function obj = compute_sigma_alpha(obj,varargin)
            ...
            if obj.nsurfaces == 1
                fluxsigmaD = TaylorState.mtxfluxsigma( ...
                    obj.surf{1},obj.dom{1},obj.L{1}, ...
                    [obj.domparams 0 1],dfunc{1}, ...
                    obj.zk,obj.eps_taylor,obj.eps_laphelm, ...
                    obj.surf{1},obj.quad_opts_taylor{1}, ...
                    obj.quad_opts_laphelm{1});
                fluxalpha = TaylorState.mtxfluxalpha( ...
                    obj.surf{1},obj.dom{1}, ...
                    [obj.domparams 0 1 1],obj.mH{1}, ...
                    obj.zk,obj.eps_taylor,obj.eps_laphelm, ...
                    obj.surf{1},obj.quad_opts_taylor{1}, ...
                    obj.quad_opts_laphelm{1});
            else
                fluxsigmaD = TaylorState.mtxfluxsigmanew(obj.surf, ...
                    obj.dom,obj.vn,obj.L,obj.domparams,dfunc,obj.zk, ...
                    obj.eps_taylor,obj.eps_laphelm,obj.surf, ...
                    obj.quad_opts_taylor,obj.quad_opts_laphelm);
                fluxalpha = TaylorState.mtxfluxalphanew(obj.surf, ...
    ...
    methods (Static)
        ...
        fluxsigma1 = mtxfluxsigmanew(S,dom,vn,L,domparams,sigma,zk,epstaylor,epslh,varargin)
        fluxalpha = mtxfluxalpha(S,dom,domparams,mH,zk,epstaylor,epslh,varargin)
        flusalpha1 = mtxfluxalphanew(S,dom,vn,domparams,mH,zk,epstaylor,epslh,varargin)
