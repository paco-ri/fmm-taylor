...
% toroidal shell case
    ...
    if abs(zk) < eps
        ...
        S0nxi = taylor.helper.lap_dir_vec_eval(Si,nxi.',targinfoi,epslh, ...
            dpars,optslhi);
        S0nxo2i = taylor.helper.lap_dir_vec_eval(Si,nxo2i.',targinfoi,epslh, ...
            dpars);
        S0nxi2o = taylor.helper.lap_dir_vec_eval(So,nxi2o.',targinfoo,epslh, ...
            dpars);
