...
# FFLAGS = -fPIC -O0 -march=native -funroll-loops -std=legacy -fbacktrace -fcheck=all -fcheck=bounds -fcheck=array-temps -finit-integer=-99999 -ffpe-trap=invalid,zero,overflow -fno-omit-frame-pointer
OMPFLAGS = -fopenmp
FFLAGS += $(OMPFLAGS)
FFLAGS += -J .mod/
